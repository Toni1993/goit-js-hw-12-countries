...
function getCountries(e) {
  ...
  (0, _fetchCountries.fetchCountry)(getCountries).then(function (data) {
    ...
    listRef.innerHTML = '';
    item.innerHTML = '';
    var countries = data.splice(-10).map(function (elem, i, arr) {
      if (arr.length == 1) {
        return "\n          <h2 class=\"country-title\">".concat(elem.name, "</h2>\n          <ul class=\"country-list\">\n            <li class=\"country-item\">\n              <span class=\"title-name\">Capital: </span>\n              <span class=\"title-value\">").concat(elem.capital, "</span>\n            </li>\n            <li class=\"country-item\">\n              <span class=\"title-name\">Population:</span>\n              <span class=\"title-value\">").concat(elem.population, "</span>\n            </li>\n            <li class=\"country-item \">\n              <span class=\"title-name\">Language :</span>\n              <ul class=\"language-list\">\n                  <li class=\"language-item\">").concat(elem.name, "</li>\n              </ul>\n            </li>\n          </ul>\n          <img class=\"flag-img\" src=\"").concat(elem.flag, "\" alt=\"flag\" width=\"500\" height=\"300\">\n        ");
      } else {
        return "<li>".concat(elem.name, "</li>");
      }
    }).join('');
...
},{"./js/fetchCountries":"js/fetchCountries.js","lodash.debounce":"../node_modules/lodash.debounce/index.js","@pnotify/core":"../node_modules/@pnotify/core/dist/PNotify.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
